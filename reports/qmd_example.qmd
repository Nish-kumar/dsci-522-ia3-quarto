...
## Results
![Horse populations](../results/horse_pops_plot.png){#fig-label width=110% fig-pos="H"}
...
![Horse populations with large sd province](../results/horse_pops_plot_largest_sd.png){#fig-label width=70% fig-pos="H"}
